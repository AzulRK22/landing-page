...
(function ($) {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    const ecommerceSwiper = new Swiper('.ecommerce-swiper', {
        loop: true,
        pagination: {
            el: '.ecommerce-swiper-pagination',
            clickable: true,
        },
        navigation: {
            nextEl: '.ecommerce-swiper-button-next',
            prevEl: '.ecommerce-swiper-button-prev',
        },
        slidesPerView: 1,
        spaceBetween: 10,
    });

    const fellowAISwiper = new Swiper('.fellow-ai-swiper', {
        loop: true,
        pagination: {
            el: '.fellow-ai-swiper-pagination',
            clickable: true,
        },
        navigation: {
            nextEl: '.fellow-ai-swiper-button-next',
            prevEl: '.fellow-ai-swiper-button-prev',
        },
        slidesPerView: 1,
        spaceBetween: 10,
    });
